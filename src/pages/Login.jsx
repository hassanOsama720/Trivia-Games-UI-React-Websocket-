...
export default function Login() {
  ...
  return (
    <div className="container vh-100 pt-5 d-flex flex-column justify-content-evenly align-items-center flex-wrap" style={{backgroundColor:"#122641"}}>
        <div className="container d-flex flex-column justify-content-evenly align-items-center flex-wrap rounded-5 p-1" style={{backgroundColor:"#28547d",height:"65%",width:"90%"}}>
