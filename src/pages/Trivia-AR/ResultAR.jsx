...
export default function ResultAR() {
  ...
  return (
    <div className="container-fluid p-0 vh-100 d-flex flex-column align-items-center justify-content-evenly" style={{backgroundColor:"#122641"}}>
        <div className="head w-100 mb-1 rounded-bottom d-flex justify-content-center align-items-center" style={{height:"6%",backgroundColor:"white"}}>
            <h3 style={{color:"#617C95"}}>النتائج</h3>
        </div>
        {
            list.length > 0?
            <>
        <div className="contant d-flex flex-column align-items-center justify-content-evenly" style={{width:"100%",height:"88%"}}>
            ...
            <button  onClick={handelNext} className='w-50 rounded-pill' style={{height:"50px",border:"none",backgroundColor:"#617C95",color:"white",fontWeight:"bold",fontSize:"large",boxShadow:"#3b5057 0px 0px 7px 2px"}} name='signUp'>التالى</button> 
            ...
            </> : <div style={{color:"white"}}>لا يوجد نتائج لعرضها <Link to={"/manage"}>صفحه الاعدادات</Link></div>
        }
