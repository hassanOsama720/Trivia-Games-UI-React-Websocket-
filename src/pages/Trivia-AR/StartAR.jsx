...
export default function StartAR(props) {
  ...
  return (
    <div className="container p-0 fluid vh-100 d-flex flex-column align-items-center  flex-wrap" style={{backgroundColor:"orange"}}>
        ...
        {cookies.config.camera? <div className="camera rounded-4 " style={{width:"90%",height:"40%",border:"solid 1px white",overflow:"hidden"}}>
            ...
            <div className=" w-100 flex-column d-flex justify-content-evenly align-items-center" style={{height:"50%"}}>
                <h2 style={{fontSize:"50px"}} onClick={()=>{nav("/gameAR")}}>ابدأ</h2>
            ...
            <button  onClick={handelSocket} className='w-50 rounded-pill' style={{height:"50px",border:"none",backgroundColor:"#617C95",color:"white",fontWeight:"bold",fontSize:"large"}} name='signUp'>اعد الاتصال</button> 
